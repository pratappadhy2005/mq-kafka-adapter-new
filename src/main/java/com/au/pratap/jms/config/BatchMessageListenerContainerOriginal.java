package com.au.pratap.jms.config;
 ...
 *
 */
public class BatchMessageListenerContainerOriginal extends DefaultMessageListenerContainer {
    ...
    private ContainerDelegate delegate = new ContainerDelegate() {
        ...
        public boolean receiveAndExecute(Object invoker, Session session, MessageConsumer consumer) throws JMSException {
            return BatchMessageListenerContainerOriginal.super.receiveAndExecute(invoker, session, consumer);
        }
    };
